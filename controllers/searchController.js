...
exports.searchLetsbookDefaultHotelWithMinimumData = async (req, res) => {
	try {
		...
		console.error(error)
		res.status(400).send('Não foi possível buscar as informações da reserva para o Pratagy Beach Resort All Inclusive, com os dados fornecidos.')
	}
}
function isDatePeriodValid(checkinDateParts, checkoutDateParts) { //YYYY-MM-DD
