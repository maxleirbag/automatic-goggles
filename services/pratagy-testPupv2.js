...
await page.evaluate(()=>{
  ...
  teste = Array.from(itens)
  // console.log(['teste', teste])

  const atributosDeInteresse = teste.map((cada)=> cada.innerText)
  console.log(atributosDeInteresse)

  const fragmentados = atributosDeInteresse.map((hotel)=> {
    return hotel.split('\t')
  })
  console.log(fragmentados)
})
// TARGET 
// #acomodacoesWrapper
